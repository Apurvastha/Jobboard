...
class TestJobListingList:
    ...
    def test_no_n_plus_1_on_list(self, api_client, multiple_job_listings, django_assert_num_queries):
        """
...
class TestJobListingCreate:
    ...
    def test_company_can_create_job(self, company_client, category):
        ...
        response = company_client.post('/api/v1/jobs/', {
    ...
    def test_candidate_cannot_create_job(self, candidate_client, category):
        ...
        response = candidate_client.post('/api/v1/jobs/', {
...
class TestJobListingUpdate:
    ...
    def test_other_company_cannot_update_job(
        self, another_company_client, job_listing
    ):
